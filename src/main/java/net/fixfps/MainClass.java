...
public class MainClass implements ModInitializer {
	...
	public static final Block RickTorch = new RickTorch(FabricBlockSettings.of(Material.AGGREGATE).strength(1, 1).breakByHand(true).luminance(15).noCollision());
	public static final Item RickTorch_ITEM = new BlockItem(RickTorch, new Item.Settings().group(ItemGroup.TOOLS));
